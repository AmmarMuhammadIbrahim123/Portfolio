  ...
  return (
    ...
    id="About" className="w-full px-[12%] py-10 scroll-mt-20 ">
     ...
     transition={{duration:0.5,delay:0.3}}
      className="text-center mb-2 text-lg font-serif">Introduction</motion.h4>
      <motion.h2
       initial={{y:-20, opacity:0}}
     whileInView={{y:0, opacity:1}}
     transition={{duration:0.5,delay:0.5}}
       className="text-center text-5xl font-serif">About me</motion.h2>
      <motion.div
      initial={{opacity:0}}
      whileInView={{opacity:1}}
     ...
     transition={{duration:0.5}}
        ...
        className="flex-1">
          ...
          className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            {infoList.map(({icon,iconDark,title,description},index)=>(
               ...
               whileHover={{scale:1.05}}
                ...
                hover:-translate-y-1 duration-500  hover:shadow-lg hover:shadow-black" key={index}>
          ...
          className="my-6 text-gray-700 font-serif">Tools I Use </motion.h4>
          <motion.ul
          initial={{opacity:0}}
          whileInView={{opacity:1}}
