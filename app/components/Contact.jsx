...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "4805ee22-bc04-4983-acdb-abaaad594050");
  ...
  return (
    ...
    bg-no-repeat bg-center bg-[length:90%_auto] ">
      ...
      transition={{delay:1.1, duration:0.6}}
          ...
          type="text" placeholder="Enter your email" required className="flex-1 p-3 outline-none border-[0.5px] 
          ...
          className="w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white" name="message"></motion.textarea>

          <motion.button
         whileHover={{scale:1.05}}
         transition={{duration:0.3}}
          type="submit" 
          className="  py-3 mt-8 px-8 w-max flex items-center justify-between gap-2 bg-black/80
          text-white rounded-full mx-auto hover:bg-black duration-500">Submit now
          <Image src={assets.right_arrow} alt="btn" className="w-4"/>
          </motion.button>
