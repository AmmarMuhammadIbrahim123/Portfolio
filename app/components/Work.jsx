...
const Work = () => {
  return (
    <div id="Work" className="w-full px-[12%] py-10 scroll-mt-20 ">
      ...
      <h2 className="text-center text-5xl font-serif">My Latest Work</h2>

      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-serif">
        Welcome to my web development portfolio! Explore a collection of
        projects showcasing my expertise in front-end development.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 mx-auto  my-10 gap-5">
