...
const Work = () => {
  return (
    ...
    transition={{delay:0.3,duration:0.5}}
      className="text-center mb-2 text-lg font-serif">My Portfolio</motion.h4>
      <motion.h2 
       initial={{y:-20, opacity:0}}
    whileInView={{y:0,opacity:1}}
    transition={{delay:0.5,duration:0.5}}
      className="text-center text-5xl font-serif">My Latest Work</motion.h2>
    ...
    transition={{delay:0.9,duration:0.6}}
      className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 mx-auto  my-10 gap-5">
